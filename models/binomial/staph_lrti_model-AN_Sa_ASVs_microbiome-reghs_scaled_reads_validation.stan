...
model {
  ...
  alpha ~ normal(0, 1);
  for ( i in 1:n ) {
        p[i] = beta[seqvar_id[i]] * read_count[i] + b_total * specimen_read_total[i] + b_asv_adcd * asv_adcde8c78396022660fd6204471c65c8[i] + b_asv_f011 * asv_f011d78941f0c011aca75252ef604d17[i] + alpha;
    }
